...
var fightOrSkip = function() {
  //ask if they want to fight or skip using this^ function
  ...
  // Skip confirms and then stops loop
  if (promptFight === "skip") {
    //confirm skip
    ...
    if (confirmSkip) {
      ...
      //subtract money from player for skip
...
var shop = function() {
  ...
  shopOptionPrompt = parseInt(stopOptionPrompt);
